...
export class ForgotpasswordComponent implements OnInit {
    ...
    updatePassword() {
        ...
        else if (this.forgotPasswordData.password != this.forgotPasswordData.confirmPassword) {
            var errorMessage = 'Both password must match';
            this._message.showError(errorMessage);
        }
        else {
            var forgotPasswordData = this.forgotPasswordData
            forgotPasswordData['userType'] = 'admin';
